...
```Bash
git clone https://github.com/FedorDymovskij/ticket-cinema
``` 
2. Перейдите в папку проекта
```Bash
cd .../ticket-cinema
```
3. Установите JDK 25 и Apache Maven (Если не установлено)
4. Соберите проект (либо используйте заранее скомпилированный проект)
```Bash 
...
*   `403 Forbidden` — Недостаточно прав (например пользователь с ролью **USER** пытается зайти на защищенный ресурс `/admin`).
