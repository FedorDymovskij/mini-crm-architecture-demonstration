package org.application.crm_DDD.core.handler;

//import org.application.securitydemonstration.MISC.security.exception.DTO.BasicExceptionDTO;
//import org.application.securitydemonstration.MISC.security.exception.code.BasicExceptionCode;

import org.application.crm_DDD.core.exception.*;
import org.application.crm_DDD.core.web.exception_mapper.CoreExceptionMapper;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CoreExceptionDTO> handleDomainException(final DomainException exception) {
        ...
        // Ищем маппер, который умеет обрабатывать этот тип спецификации
