package org.application.crm_DDD.features.user_context.infrastructure.web.use_case.assign_account_as_user;
...
public class AssignAccountAsUserController {
    ...
    public ResponseEntity<Void> assignAccountAsUser(
        ...
        var command = new AssignAccountAsUserCommand(initiatorAccountId, targetAccountId);

        this.assignAccountAsUserUseCase.execute(command);
