package org.application.crm_DDD.features.user_context.infrastructure.web.use_case.assign_account_as_moderator;
...
public class AssignAccountAsModeratorController {
    ...
    public ResponseEntity<Void> assignAccountAsModerator(
        ...
        var command = new AssignAccountAsModeratorCommand(initiatorAccountId, targetAccountId);

        this.assignAccountAsModeratorUseCase.execute(command);
